...
export const siteConfig: SiteConfig = {
	...
	bilibili: {
		vmid: "3494354542922358", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "Github",
					url: "https://github.com/AceCookie-1173",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/3494354542922358",
					external: true,
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/1769309205180.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "Acecookie",
	bio: "只是一棵枫树",
	typewriter: {
